...
try:
    subprocess.run(["hdfs", "dfs", "-rm", "-r", output_dir], check=True)    # removing so that on consecutive builds it doesn't cause an error
...
# Save the transformed RDD as a single partition
